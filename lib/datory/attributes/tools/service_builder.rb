    ...
    module Tools
      class ServiceBuilder
        class ServiceFactory
          ...
          def self.create(model_class, collection_of_attributes)
            return if model_class.const_defined?(SERVICE_CLASS_NAME)
            ...
            model_class.const_set(SERVICE_CLASS_NAME, class_sample)
          end
          # rubocop:enable Metrics/MethodLength, Metrics/AbcSize, Metrics/CyclomaticComplexity, Metrics/PerceivedComplexity
        end
        private_constant :ServiceFactory

        SERVICE_CLASS_NAME = "GBuilder"
        private_constant :SERVICE_CLASS_NAME
